...
def remove_from_favorites(book_id):
    ...
    print(f"❌ Removed book {book_id} from favorites")
...
""") as demo:
    ...
    favorites_load_more_btn.click(load_more_favorites,
    ...
    function isBookInFavorites(bookId) {
        ...
        return bookCard ? bookCard.querySelector('.book-title').textContent.includes('❤️') : false;
    }
