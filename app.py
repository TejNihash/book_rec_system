...
""") as demo:
    ...
    function triggerFavoriteAction(bookId, action) {
        ...
        // Find the hidden Gradio components using more specific selectors
        const gradioApp = document.querySelector('gradio-app');
        const inputs = gradioApp.querySelectorAll('input');
        const buttons = gradioApp.querySelectorAll('button');
        
        let bookIdInput, actionInput, triggerBtn;
        
        // Find components by their labels
        ...
        for (let btn of buttons) {
            ...
            if (text.includes('Trigger Favorite')) {
                triggerBtn = btn;
                break;
            }
        }
        ...
        if (bookIdInput && actionInput && triggerBtn) {
            ...
            setTimeout(() => {
                ...
                showFeedback(message, action === 'add');
                
                // Update the button in popup after a delay
