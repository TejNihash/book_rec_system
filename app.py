...
BOOKS_PER_LOAD = 12  # 2 rows of 6 cards
...
.books-container { display:grid; grid-template-columns:repeat(6,1fr); gap:15px; 
...
.book-card.expanded { grid-column: span 6; height:auto; }
