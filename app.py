...
# ---------- Gradio UI with restricted height and light theme details ----------
with gr.Blocks(css="""
.books-section {
...
/* ... (all other CSS remains exactly the same until detail overlay) ... */
...
""") as demo:
    ...
    # ---------- Updated Detail Popup with Light Theme ----------
    gr.HTML("""
    ...
    document.addEventListener('click', e=>{
        ...
        document.getElementById('detail-content').innerHTML = `
            ...
            <div style="margin-top:15px;">
                ...
                <div style="background:#f8f9ff;padding:15px;border-radius:8px;border-left:4px solid #667eea;font-size:14px;line-height:1.6;color:#222;">
