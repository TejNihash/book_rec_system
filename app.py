...
def get_book_details(book_id):
    ...
    # Additional details you might have in your dataset
    ...
    return details_html, title, authors, genres, description, image_url
...
def show_book_details(book_id):
    ...
    details_html, title, authors, genres, description, image_url = get_book_details(book_id)
    return gr.update(visible=True, value=details_html), book_id
...
""") as demo:
    ...
    with gr.Column(visible=False) as modal:
        with gr.Blocks() as modal_content:
    ...
    selected_book_id = gr.State(None)
    book_click_trigger = gr.Textbox(visible=False)
    ...
    search_box.submit(
        initial_state,
        [search_box],
        [random_display, popular_display, random_page, popular_page, load_random_btn, load_popular_btn, random_title, random_loaded_books, popular_loaded_books, selected_book_id]
    )
    ...
    clear_btn.click(
        clear_search,
        [],
        [search_box, random_display, popular_display, random_page, popular_page, load_random_btn, load_popular_btn, random_title, random_loaded_books, popular_loaded_books, selected_book_id]
    )
