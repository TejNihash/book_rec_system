...
""") as demo:
    ...
    const container = document.querySelector('.books-section'); // delegate clicks here
    ...
    document.addEventListener('click', e => { 
        if(!e.target.closest('.book-card') && !e.target.closest('#card-details-popup')) popup.style.display = 'none'; 
    });
    </script>
